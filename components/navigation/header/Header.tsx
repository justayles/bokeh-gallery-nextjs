...
import BurgerMenu from 'components/navigation/menu/burger/BurgerMenu';
import MainMenu from 'components/navigation/menu/main/MainMenu';
import UserMenu from 'components/navigation/menu/user/UserMenu';
  ...
  return (
    ...
    >
      <div className="container flex justify-start items-center h-20 gap-10">
        ...
        <BurgerMenu />
        <UserMenu links={userDropdownLinks} />
      </div>
    </header>
  );
};
